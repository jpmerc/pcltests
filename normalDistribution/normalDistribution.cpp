...
Eigen::Matrix4f normalDistributionTransform(pcl::PointCloud<PointT>::Ptr src_cloud, pcl::PointCloud<PointT>::Ptr target_cloud){
        pcl::ScopeTime t("Normal Distribution Transform");
...
//    Eigen::Matrix4f model_to_scene_2_icp = align_icp(container_model, in2, model_to_scene_2_coarse, 0.8);
    Eigen::Matrix4f model_to_scene_2_coarse = normalDistributionTransform(container_model, in2);
  //  Eigen::Matrix4f model_to_scene_2_icp = align_icp(container_model, in2, model_to_scene_2_coarse, 0.8);
  ...
  //  pcl::transformPointCloud(*container_model, *container_scene2_icp, model_to_scene_2_icp);
    ...
    pclViewer->addPointCloud (container_model, ColorHandlerT(container_model, 255.0, 255.0, 0.0), "coarse");
