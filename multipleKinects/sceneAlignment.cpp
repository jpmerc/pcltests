...
void getFitnessScore(pcl::PointCloud<PointT>::Ptr src_cloud, pcl::PointCloud<PointT>::Ptr target_cloud){
    ...
    cout << "Transformation = " << endl << icp_transform << endl;
...
int main (int argc, char** argv){
    ...
    Eigen::Matrix4f scene_to_scene_icp = align_icp(in2_subsampled, in1_subsampled, guess, 0.03);
    pcl::transformPointCloud(*in2, *transformed_scene, scene_to_scene_icp);


    pclViewer3->addPointCloud (in1, ColorHandlerT(in1, 255.0, 0.0, 0.0), "in1");
    pclViewer3->setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1, "in1");

    pclViewer3->addPointCloud (in2, ColorHandlerT(in2, 0.0, 255.0, 0.0), "in2");
    pclViewer3->setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1, "in2");

    pclViewer3->addPointCloud (transformed_scene, ColorHandlerT(transformed_scene, 0.0, 0.0, 255.0), "transformed_scene");
    pclViewer3->setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1, "transformed_scene");


    in2 = transformed_scene;
...
//    pclViewer2->setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 1, "in1");
    ...
    // Crop box on scene 1
    pcl::PointCloud<PointT>::Ptr objects (new pcl::PointCloud<PointT>);
    bb_filter2.setInputCloud(in1);
    bb_filter2.filter(*objects);


    getFitnessScore(objects2, objects);

    pclViewer2->addPointCloud (objects2, ColorHandlerT(objects2, 255.0, 0.0, 0.0), "hull2");
    pclViewer2->setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 3, "hull2");
